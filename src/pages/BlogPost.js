                ...
                <div className="max-w-4xl mx-auto px-6 py-12">
                    ...
                    <article
                        className={`rounded-xl p-10 border transition-all duration-300 ${
                            darkMode
                                ? "bg-[#1A1330] border-[#3A2F55] shadow-[0_8px_20px_rgba(0,0,0,0.5)]"
                    ...
                    >
                        ...
                        {/* CONTENT */}
                        <section
                            className={`prose prose-md max-w-none mb-6 transition-all duration-300 ${
                        ...
                        >
                            ...
                            <h3
                                style={{ color: darkMode ? "#BFA8FF" : "#6B4EFF" }}
                            >
                            ...
                            <h3 style={{ color: darkMode ? "#BFA8FF" : "#6B4EFF" }}>
                            ...
                            <h4
                                style={{ color: darkMode ? "#D6C8FF" : "#4B2E83" }}
                            >
                                Possible Scenarios
                            </h4>
